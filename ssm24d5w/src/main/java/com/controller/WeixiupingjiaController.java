...
public class WeixiupingjiaController {
    ...
    public R page(@RequestParam Map<String, Object> params,WeixiupingjiaEntity weixiupingjia, HttpServletRequest request){
		...
		if(tableName.equals("keshiyuan")) {
			weixiupingjia.setKeshiyuangonghao((String)request.getSession().getAttribute("username"));
		}
		if(tableName.equals("weixiuyuan")) {
			weixiupingjia.setWeixiuyuangonghao((String)request.getSession().getAttribute("username"));
		}
