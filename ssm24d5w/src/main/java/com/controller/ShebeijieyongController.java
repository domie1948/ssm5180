...
public class ShebeijieyongController {
     ...
     */
    @RequestMapping("/page")
    public R page(@RequestParam Map<String, Object> params,ShebeijieyongEntity shebeijieyong, HttpServletRequest request){
     ...
     */
    @RequestMapping("/list")
    public R list(@RequestParam Map<String, Object> params,ShebeijieyongEntity shebeijieyong, HttpServletRequest request){
        EntityWrapper<ShebeijieyongEntity> ew = new EntityWrapper<ShebeijieyongEntity>();
		PageUtils page = shebeijieyongService.queryPage(params, MPUtil.sort(MPUtil.between(MPUtil.likeOrEq(ew, shebeijieyong), params), params));
        return R.ok().put("data", page);
    }
	...
	public R remindCount(@PathVariable("columnName") String columnName, HttpServletRequest request, 
		...
		Wrapper<ShebeijieyongEntity> wrapper = new EntityWrapper<ShebeijieyongEntity>();
		if(map.get("remindstart")!=null) {
		...
		int count = shebeijieyongService.selectCount(wrapper);
