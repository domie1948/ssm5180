...
public class ShebeichukuController {
     ...
     */
    @RequestMapping("/page")
    public R page(@RequestParam Map<String, Object> params,ShebeichukuEntity shebeichuku, HttpServletRequest request){
     ...
     */
    @RequestMapping("/list")
    public R list(@RequestParam Map<String, Object> params,ShebeichukuEntity shebeichuku, HttpServletRequest request){
        EntityWrapper<ShebeichukuEntity> ew = new EntityWrapper<ShebeichukuEntity>();
		PageUtils page = shebeichukuService.queryPage(params, MPUtil.sort(MPUtil.between(MPUtil.likeOrEq(ew, shebeichuku), params), params));
        return R.ok().put("data", page);
    }
	...
	public R remindCount(@PathVariable("columnName") String columnName, HttpServletRequest request, 
		...
		Wrapper<ShebeichukuEntity> wrapper = new EntityWrapper<ShebeichukuEntity>();
		if(map.get("remindstart")!=null) {
		...
		int count = shebeichukuService.selectCount(wrapper);
