...
public class ShebeiweixiuController {
     ...
     */
    @RequestMapping("/page")
    public R page(@RequestParam Map<String, Object> params,ShebeiweixiuEntity shebeiweixiu, HttpServletRequest request){

		String tableName = request.getSession().getAttribute("tableName").toString();
		if(tableName.equals("keshiyuan")) {
			shebeiweixiu.setKeshiyuangonghao((String)request.getSession().getAttribute("username"));
		}
		if(tableName.equals("weixiuyuan")) {
			shebeiweixiu.setWeixiuyuangonghao((String)request.getSession().getAttribute("username"));
		}
     ...
     */
    @RequestMapping("/list")
    public R list(@RequestParam Map<String, Object> params,ShebeiweixiuEntity shebeiweixiu, HttpServletRequest request){
        EntityWrapper<ShebeiweixiuEntity> ew = new EntityWrapper<ShebeiweixiuEntity>();
		PageUtils page = shebeiweixiuService.queryPage(params, MPUtil.sort(MPUtil.between(MPUtil.likeOrEq(ew, shebeiweixiu), params), params));
        return R.ok().put("data", page);
    }
