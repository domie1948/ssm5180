...
public class WeixiuyuanController {
	...
	public R login(String username, String password, String captcha, HttpServletRequest request) {
		WeixiuyuanEntity user = weixiuyuanService.selectOne(new EntityWrapper<WeixiuyuanEntity>().eq("weixiuyuangonghao", username));
    ...
    public R register(@RequestBody WeixiuyuanEntity weixiuyuan){
    	...
    	WeixiuyuanEntity user = weixiuyuanService.selectOne(new EntityWrapper<WeixiuyuanEntity>().eq("weixiuyuangonghao", weixiuyuan.getWeixiuyuangonghao()));
		if(user!=null) {
