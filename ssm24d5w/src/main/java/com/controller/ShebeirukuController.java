...
public class ShebeirukuController {
     ...
     */
    @RequestMapping("/page")
    public R page(@RequestParam Map<String, Object> params,ShebeirukuEntity shebeiruku, HttpServletRequest request){
     ...
     */
    @RequestMapping("/list")
    public R list(@RequestParam Map<String, Object> params,ShebeirukuEntity shebeiruku, HttpServletRequest request){
        EntityWrapper<ShebeirukuEntity> ew = new EntityWrapper<ShebeirukuEntity>();
		PageUtils page = shebeirukuService.queryPage(params, MPUtil.sort(MPUtil.between(MPUtil.likeOrEq(ew, shebeiruku), params), params));
        return R.ok().put("data", page);
    }
	...
	public R remindCount(@PathVariable("columnName") String columnName, HttpServletRequest request, 
		...
		Wrapper<ShebeirukuEntity> wrapper = new EntityWrapper<ShebeirukuEntity>();
		if(map.get("remindstart")!=null) {
		...
		int count = shebeirukuService.selectCount(wrapper);
