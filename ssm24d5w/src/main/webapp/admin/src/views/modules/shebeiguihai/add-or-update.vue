          ...
          <el-form-item class="input" label="借用人" prop="jieyongren">
              <el-input v-model="ruleForm.jieyongren" 
                placeholder="借用人" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="借用日期" prop="jieyongriqi">
          <el-input v-model="ruleForm.jieyongriqi" 
              placeholder="借用日期" clearable  :readonly="ro.jieyongriqi"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="借用日期" prop="jieyongriqi">
              <el-input v-model="ruleForm.jieyongriqi" 
