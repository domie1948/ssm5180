          ...
          <el-form-item class="input" label="设备名称" prop="shebeimingcheng">
              <el-input v-model="ruleForm.shebeimingcheng" 
                placeholder="设备名称" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="借用人" prop="jieyongren">
          <el-input v-model="ruleForm.jieyongren" 
              placeholder="借用人" clearable  :readonly="ro.jieyongren"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="借用人" prop="jieyongren">
              <el-input v-model="ruleForm.jieyongren" 
                placeholder="借用人" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="借用日期" prop="jieyongriqi">
            <el-date-picker
                format="yyyy 年 MM 月 dd 日"
                value-format="yyyy-MM-dd"
                v-model="ruleForm.jieyongriqi" 
                type="date"
                placeholder="借用日期">
            </el-date-picker> 
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.jieyongriqi" label="借用日期" prop="jieyongriqi">
              <el-input v-model="ruleForm.jieyongriqi" 
                placeholder="借用日期" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
...
export default {
  ...
  methods: {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.shebeimingcheng = true;
            continue;
	            	            ...
	            	            if(o=='jieyongren'){
            this.ruleForm.jieyongren = obj[o];
	    this.ro.jieyongren = true;
            continue;
          }
	            	            if(o=='jieyongriqi'){
            this.ruleForm.jieyongriqi = obj[o];
	    this.ro.jieyongriqi = true;
            continue;
          }
	            	            if(o=='beizhu'){
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `shebeijieyong/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.shebeijieyongCrossAddOrUpdateFlag = false;
                  this.parent.search();
