          ...
          <el-form-item class="input" label="设备名称" prop="shebeimingcheng">
              <el-input v-model="ruleForm.shebeimingcheng" 
                placeholder="设备名称" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="报废内容" prop="baofeineirong">
          <el-input v-model="ruleForm.baofeineirong" 
              placeholder="报废内容" clearable  :readonly="ro.baofeineirong"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="报废内容" prop="baofeineirong">
              <el-input v-model="ruleForm.baofeineirong" 
                placeholder="报废内容" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="报废日期" prop="baofeiriqi">
            <el-date-picker
                format="yyyy 年 MM 月 dd 日"
                value-format="yyyy-MM-dd"
                v-model="ruleForm.baofeiriqi" 
                type="date"
                placeholder="报废日期">
            </el-date-picker> 
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.baofeiriqi" label="报废日期" prop="baofeiriqi">
              <el-input v-model="ruleForm.baofeiriqi" 
                placeholder="报废日期" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
...
export default {
  ...
  methods: {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.shebeimingcheng = true;
            continue;
	            	            ...
	            	            if(o=='baofeineirong'){
            this.ruleForm.baofeineirong = obj[o];
	    this.ro.baofeineirong = true;
            continue;
          }
	            	            if(o=='baofeiriqi'){
            this.ruleForm.baofeiriqi = obj[o];
	    this.ro.baofeiriqi = true;
            continue;
          }
	            	            if(o=='beizhu'){
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `shebeibaofei/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.shebeibaofeiCrossAddOrUpdateFlag = false;
                  this.parent.search();
