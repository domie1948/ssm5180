          ...
          <el-form-item class="input" v-if="ruleForm.shengchanriqi" label="生产日期" prop="shengchanriqi">
              <el-input v-model="ruleForm.shengchanriqi" 
                placeholder="生产日期" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="设备详情" prop="shebeixiangqing">
          <el-input v-model="ruleForm.shebeixiangqing" 
              placeholder="设备详情" clearable  :readonly="ro.shebeixiangqing"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="设备详情" prop="shebeixiangqing">
              <el-input v-model="ruleForm.shebeixiangqing" 
                placeholder="设备详情" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                              </el-row>
