...
export default {
            ...
            ruleForm: {
                	        keshiyuangonghao: '',
	                        	        ...
	                        	        youxiang: '',
                                                              ...
                                                              rules: {
                  keshiyuangonghao: [
                            { required: true, message: '科室员工号不能为空', trigger: 'blur' },
                                    	                                                              ],
                  mima: [
                            { required: true, message: '密码不能为空', trigger: 'blur' },
                                    	                                                              ],
                  keshiyuanxingming: [
                            { required: true, message: '科室员姓名不能为空', trigger: 'blur' },
                                    	                                                              ],
                  touxiang: [
                                    	                                                              ],
                  xingbie: [
  ...
  methods: {
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `keshiyuan/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.keshiyuanCrossAddOrUpdateFlag = false;
                  this.parent.search();
