          ...
          <el-form-item class="input" label="科室" prop="keshi">
              <el-input v-model="ruleForm.keshi" 
                placeholder="科室" readonly></el-input>
                                                    ...
                                                    <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="保养内容" prop="baoyangneirong">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="保养内容"
                  v-model="ruleForm.baoyangneirong" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.baoyangneirong" label="保养内容" prop="baoyangneirong">
                    <span>{{ruleForm.baoyangneirong}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.shebeimingcheng = true;
            continue;
	            	            ...
	            	            if(o=='baoyangneirong'){
            this.ruleForm.baoyangneirong = obj[o];
	    this.ro.baoyangneirong = true;
            continue;
          }
	            	            if(o=='yuyueriqi'){
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `baoyangyuyue/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.baoyangyuyueCrossAddOrUpdateFlag = false;
                  this.parent.search();
