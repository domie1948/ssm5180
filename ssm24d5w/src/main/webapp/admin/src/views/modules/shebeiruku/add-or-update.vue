          ...
          <el-form-item class="input" label="设备名称" prop="shebeimingcheng">
              <el-input v-model="ruleForm.shebeimingcheng" 
                placeholder="设备名称" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="入库数量" prop="rukushuliang">
          <el-input v-model="ruleForm.rukushuliang" 
              placeholder="入库数量" clearable  :readonly="ro.rukushuliang"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="入库数量" prop="rukushuliang">
              <el-input v-model="ruleForm.rukushuliang" 
...
export default {
  ...
  methods: {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.shebeimingcheng = true;
            continue;
	            	            ...
	            	            if(o=='rukushuliang'){
            this.ruleForm.rukushuliang = obj[o];
	    this.ro.rukushuliang = true;
            continue;
          }
	            	            if(o=='rukuriqi'){
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `shebeiruku/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.shebeirukuCrossAddOrUpdateFlag = false;
                  this.parent.search();
